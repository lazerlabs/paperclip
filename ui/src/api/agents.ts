...
export const agentsApi = {
  ...
  adapterModels: (companyId: string, type: string, adapterConfig?: Record<string, unknown>) =>
    adapterConfig
      ? api.post<AdapterModel[]>(
          `/companies/${encodeURIComponent(companyId)}/adapters/${encodeURIComponent(type)}/models/discover`,
          { adapterConfig },
        )
