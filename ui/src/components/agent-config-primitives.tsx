...
export const help: Record<string, string> = {
  ...
  baseUrl: "Base API URL for OpenAI-compatible endpoints. Example: https://host.example/v1",
  ...
  staticHeadersJson: "Optional JSON object of extra static HTTP headers for OpenAI-compatible endpoints.",
